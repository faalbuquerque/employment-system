...
feature 'Collaborator or candidate cancels application' do
  scenario 'successfully, collaborator cancels' do
    ...
    job_dba = Job.create!(title_job: 'DBA', 
                        description: 'Gerenciar database', salary_range: '5000', level: 'Sênior', requisite: 'Experiencia com Linux', date_limit: '2022-01-01', quantity: '3', company: company, status: 'Disponivel')
