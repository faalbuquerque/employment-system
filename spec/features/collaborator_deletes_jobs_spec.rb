...
feature 'Collaborator deletes jobs spec' do
  ...
  scenario 'successfully' do
    ...
    job_dev = Job.create!(title_job: 'Desenvolvedor', 
                          description: 'Desenvolvedor rails', salary_range: '3000', level: 'Sênior', requisite: 'Experiencia com Git', date_limit: '2050-01-01', quantity: '3', company: company, status: 'Disponivel')
    job_infra = Job.create!(title_job: 'Sys Adm', 
                            description: 'Gerenciar equipe', salary_range: '5000', level: 'Pleno', requisite: 'Experiencia como dba', date_limit: '2055-02-03', quantity: '2', company: company, status: 'Disponivel')
